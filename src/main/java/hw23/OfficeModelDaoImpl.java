...
public class OfficeModelDaoImpl implements OfficeModelDao {
    ...
    @Override
    public Set<OfficeModel> getAllOffices() {
        return null;
    }

    @Override
    public Set<OfficeModel> getOfficeByCity(String city) {
        return null;
    }

    @Override
    public boolean insertOfficeModel(OfficeModel officeModel) {
    ...
    @Override
    public boolean updateOfficeModel(OfficeModel officeModel) {
    ...
    @Override
    public boolean deleteOfficeModel(BigDecimal office) {
