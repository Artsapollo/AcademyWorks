...
public class TablesInfo {
    ...
    public static OrderModel orderInfo(BigDecimal id) {
        ...
        try {
            ...
            System.out.println(orderModel.getProduct());
            System.out.println(orderModel.getCustomer());
            System.out.println(orderModel.getSalesrep());
            System.out.println(orderModel.getSalesrep());
