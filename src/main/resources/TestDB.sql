...
COL CITY FORMAT A18
SELECT CITY, REGION, '$ '||(SALES-TARGET) AS STOIM
FROM OFFICES
/
...
COL STOINM FORMAT A12
SELECT MFR_ID, PRODUCT_ID, DESCRIPTION, '$ '||(QTY_ON_HAND * PRICE) AS STOIM
FROM PRODUCTS
/
...
FROM ORDERS
WHERE ORDER_DATE BETWEEN TO_DATE('01.11.1989','DD/MM/YYYY') AND TO_DATE('31.12.1989','DD/MM/YYYY')
/
...
SELECT ORDER_NUM, AMOUNT
FROM ORDERS
WHERE AMOUNT BETWEEN 30.000 AND 39.999
/

SELECT ORDER_NUM, AMOUNT
FROM ORDERS
WHERE AMOUNT BETWEEN 1.000 AND 9.999
/
...
FROM CUSTOMERS
WHERE COMPANY = 'Апельсин'
/

SELECT COMPANY, CREDIT_LIMIT
FROM CUSTOMERS
WHERE COMPANY LIKE '%н'
/

SELECT COMPANY, CREDIT_LIMIT
FROM CUSTOMERS
WHERE COMPANY LIKE '%бесы'
/

SELECT COMPANY, CREDIT_LIMIT
FROM CUSTOMERS
WHERE COMPANY LIKE 'Ап_льсин'
/
...
OR (MANAGER IS NULL AND HIRE_DATE >= TO_DATE('01.05.88','DD/MM/YYYY'))
